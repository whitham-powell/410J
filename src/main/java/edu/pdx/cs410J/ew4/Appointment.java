...
public class Appointment extends AbstractAppointment {
     ...
     *
     * @param description
     *         The appointment description, defaults to <code>" empty "</code>
     * @param beginTimeString
     *         The time the appointment begins as a <code>String</code>.
     * @param endTimeString
     *         The time the appointment ends as a <code>String</code>.
     */
